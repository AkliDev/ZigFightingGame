...
const raylib = @import("vendor/raylib-zig/lib.zig"); //call .Pkg() with the folder raylib-zig is in relative to project build.zig
...
pub fn build(b: *std.build.Builder) void {
    ...
    const exe = b.addExecutable("ZigFightingGame", "src/main.zig");
